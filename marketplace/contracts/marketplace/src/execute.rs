...
pub fn execute_set_bid(
    ...
    // Resolving issue where Bidder could specify unchecked finders fees
...
// Validation added due to the recommendation that payout function may panic due to lack of fee and royalty validation
